...
print 'Processing for acceleration: {0} -> {1}'.format(source_name, dest_name)

if ref_cell_first:
	print 'Using first cell as reference for the whole table'
else:
	print 'Using first cell of each row as reference value for that row'
...
print 'Done. Written {0} rows.'.format(rows)
